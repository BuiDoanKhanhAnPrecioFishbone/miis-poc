...
| `docs/24-cv-mall.md` | Not submitted. The CV template, the collection checklist, and the intake form for the six | Ready to send out |
| `docs/25-cv-exempel.md` | **Not submitted — specimen.** Six invented people showing the form a filled-in CV takes | Reference only |
